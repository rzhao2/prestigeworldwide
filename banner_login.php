        ...
        <div id="login">
                <form name="login_form" method ="POST" action ="login.php">
                        <table id="login_table">
                                ...
                                <tr>
                                        <td class="align_left"><input type="text" class="login_input" name="username" value="Net ID" placeholder="Net ID"/></td>
					<td class="align_left"><input type="password" class="login_input" name="password" value="Password" placeholder="Password"/></td>
